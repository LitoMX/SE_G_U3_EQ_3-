...
def bayes():
    file2read = open("pre-procesados/pokes_discret_train_proyectoU3.csv")
    ...
    ## TESTING
    #############################################################################################
    file2read = open("pre-procesados/pokes_discret_test_proyectoU3.csv")
    file_content = file2read.readlines()
    #############################################################################################
    dataset = []
    for i in file_content:
    ...
    for k in range(len(dataset)):
        ...
        for p in probabilities_per_class:
            if probabilities_per_class ==0:
                probabilities_per_class=.01
            if sum==0:
                sum=0.1
