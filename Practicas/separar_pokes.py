...
with open('pre-procesados/pokes_discretizado.csv', newline='') as csvfile:
...
with open('pre-procesados/pokes_discret_train.csv', 'w', newline='') as csvfile:
    write = csv.writer(csvfile, delimiter=',')
    for fila in m_train:
        write.writerow(fila)

with open('pre-procesados/pokes_discret_test.csv', 'w', newline='') as csvfile:
    write = csv.writer(csvfile, delimiter=',')
    for fila in m_test:
        write.writerow(fila)
